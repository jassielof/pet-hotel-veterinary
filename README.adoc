...
.Representación en Python3
[python]
----
entrada_reporte = [1/1/2021, 10/1/2021]
fechas = [
    [1/1/2021, 10/1/2021],
    [5/1/2021, 15/1/2021],
    [20/1/2021, 30/1/2021],
...
image::doc/img/0-base.png[]

=== Modelo Conceptual

[plantuml]
----
include::assets/1-conceptual.pu[]
----
